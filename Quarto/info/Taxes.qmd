...
author: Fitz Koch
date: today
description:  Sources and logic for calculating everything related to taxes (including credits)
---

All 2025 Information. We do this in a pretty basic fashion: assume standard deductions, apply standard brackets, and then calculate credits. 

# Sources

## Deductions
- See [here](https://www.irs.gov/pub/irs-pdf/p501.pdf) for Federal Deductions 
- See [Page 12](https://tax.vermont.gov/sites/tax/files/documents/Income-Booklet-2025.pdf) for VT standard deductions, and page 19 for personal exemptions (just the number of people times a constant). 
...
## Child Tax Credit
- Note: we assume that all children have SSNs. 
- See[here](https://www.irs.gov/credits-deductions/individuals/child-tax-credit) for overall information
- See[here](https://www.irs.gov/pub/irs-drop/rp-24-40.pdf) for specific values in 2025 
...
2. Calculate and Apply EITCs: 
    ...
    2. Vermont Tax Credit:
        * Just multiply federal by a flat rate